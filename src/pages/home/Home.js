...
const ApiId = "34fed84b";
const ApiKey = "235c0afdf8f1845eced337ad209da4d8";
...
const Home= () => {
  ...
  const url = `https://api.edamam.com/search?q=${query}&app_id=${ApiId}&app_key=${ApiKey}&mealType=${meal}`;
      ...
      {food ? (
        ...
        <MainContainer>
          ...
          {food.map((liste, index) => (
            <RecipeCard key={index} recipe1={liste.recipe} />
